    ...
    var content = '<div class="panel" data-role="'+elementRole+'" id="'+element_id+'">'+
        '<div class="panel_header" data-role="'+elementRole+'" >'+
            ...
            '<div class="editpart">'+
                ...
                '<div class="btn-add-in-block"></div>'+
            '</div>'+
        '</div>'+
        '<div class="panel_content">'+ form +
...
// function btnaddInBlock() {
//     $('.btn-add-in-block').on('click', '.contentElement', function(){
...
//         // lastChild = $(this).parent().parent().parent().parent().parent().find('.test').find('input.blocPosition[data-role="'+data.role+'"]'); 

//         $(this).parent().parent().parent().parent().parent().find('.test').append(  content )
//         // console.log(element_id , lastChild , indexParent)
