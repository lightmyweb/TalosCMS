$(document).ready(function () {
    ...
    //Elements Generator
    $('.buttonsGrid').on('click', '.contentElement', function(){
        ...
        if( data.current_div_class != 'accordionItems' ){
            ...
            lastChild = $(this).find('.panel:last').find('input.blocPosition[data-role="'+data.role+'"]'); 
            //$("#btn-add").clone().appendTo(".btn-add-in-block");
        }
