...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('AdminBundle:Category')->findBy(array(), array('categoryPosition' => 'ASC'));
     ...
     * Lists all category entities.
     *
     * @Route("/order", name="category_order")
     * @Method("GET")
     */
    public function orderAction()
    {
        ...
        return $this->render('AdminBundle:Category:order.html.twig', array(
            'categories' => $categories,
        ));
    }
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            $category->setUpdateuser( $this->getUser() );
             /***/
