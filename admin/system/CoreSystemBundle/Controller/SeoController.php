...
use CoreSystemBundle\Entity\Seo;
...
class SeoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $seos = $em->getRepository('CoreSystemBundle:Seo')->findAll();
    ...
    {
        $seo = new Seo();
        $form = $this->createForm('CoreSystemBundle\Form\SeoType', $seo);
    ...
    {
        $deleteForm = $this->createDeleteForm($seo);
        $editForm = $this->createForm('CoreSystemBundle\Form\SeoType', $seo);
