...
class LocaleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('CoreSystemBundle:Locales:index.html.twig', array(
            'locales' => $locales,
        ));
    }
    ...
    {
        $locale = new Locale();
        $form = $this->createForm('CoreSystemBundle\Form\LocaleType', $locale);
        ...
        return $this->render('CoreSystemBundle:Locales:new.html.twig', array(
            'locale' => $locale,
    ...
    public function showAction(Locale $locale)
    {
        ...
        return $this->render('CoreSystemBundle:Locales:show.html.twig', array(
            'locale' => $locale,
    ...
    {
        $deleteForm = $this->createDeleteForm($locale);
        $editForm = $this->createForm('CoreSystemBundle\Form\LocaleType', $locale);
        ...
        return $this->render('CoreSystemBundle:Locales:edit.html.twig', array(
            'locale' => $locale,
