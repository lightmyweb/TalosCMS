...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('CoreSystemBundle:Page:index.html.twig', array(
            'pages' => $pages,
        ));
    }
    ...
    {
        $page = new Page();
        $form = $this->createForm('CoreSystemBundle\Form\PageType', $page);
        ...
        return $this->render('CoreSystemBundle:Page:new.html.twig', array(
            'page' => $page,
    ...
    public function editAction(Request $request, Page $page)
    {
        ...
        $editForm = $this->createForm('CoreSystemBundle\Form\PageType', $page);
        ...
        return $this->render('CoreSystemBundle:Page:edit.html.twig', array(
            'page' => $page,
