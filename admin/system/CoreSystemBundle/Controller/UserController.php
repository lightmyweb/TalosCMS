...
use CoreSystemBundle\Form\UserType;
...
{   
    ...
    public function indexAction()
    {
        ...
        return $this->render(
            'CoreSystemBundle:User:index.html.twig',
            array(
                'users' => $users,
    ...
    public function newAction(Request $request)
    {
       // $this->denyAccessUnlessGranted('ROLE_ADMIN');
        $user = new User();
        $form = $this->createForm('CoreSystemBundle\Form\UserType', $user);
        ...
        return $this->render('CoreSystemBundle:User:new.html.twig', array(
    ...
    public function editAction(Request $data,$id,$result = 0)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('CoreSystemBundle:User')->find($id);
        if (!$entity) {
            throw $this->createNotFoundException('Unable to find User entity.');
        }

       
        $form = $this->createForm('CoreSystemBundle\Form\UserType', $entity, array(
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $editForm = $this->createForm('CoreSystemBundle\Form\UserType', $entity, array(
            'action' => $this->generateUrl('admin_update_user', array('id' => $entity->getIdUser())),
            'method' => 'PUT',
        ));
    ...
    private function findEntitiesRelatedToUSer($id){
        ...
        $pages = $em->getRepository('CoreSystemBundle:Page')->findAll();
